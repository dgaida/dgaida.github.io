...
Sub BatchConvertFolder()
    ...
    With Application.FileDialog(msoFileDialogFolderPicker)
        .Title = "Ordner mit PPTX/PPTM-Dateien wählen"
...
Sub BatchConvertSelectedFiles()
    ...
    With Application.FileDialog(msoFileDialogFilePicker)
        .Title = "PPTX/PPTM-Dateien wählen"
        .Filters.Clear
...
Function GetNumberingOption() As SlideNumberingOption
    GetNumberingOption = BottomLeft
End Function

Function GetNumberingOption_config() As SlideNumberingOption
...
End Sub
Sub PrintTemporarySlides_old(oPresentation As Presentation)
    Dim response As Integer
    ...
    With oPresentation
        ...
        .PrintOut ' False, , , , , , True, _
                  ' Replace(.FullName, ".pptx", "ated.pdf")
    End With
